...
int global_newimageinverseprobability = 100; //between 1 and 100, 1 for newimage on every beat, 100 for new image only once every 100 times
	...
	{    
		...
		{  
			...
			for(int iframe=0; iframe<maxnumberofframeforthisbeat; iframe++)
			{
				...
				{
					xstep = (global_fractaltrace_xmax-global_fractaltrace_xmin)*global_maxwindowwidthtranslationmultiple/(double) maxnumberofframeforthisbeat; //translation should be somewhat fast
					ystep = (global_fractaltrace_ymax-global_fractaltrace_ymin)*global_maxwindowwidthtranslationmultiple/(double) maxnumberofframeforthisbeat;
				}
