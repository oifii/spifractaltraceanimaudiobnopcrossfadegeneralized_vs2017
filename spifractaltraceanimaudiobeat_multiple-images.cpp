...
string global_outputimagefolder = "C:\\temp(fractal-trace-anim-audio-beat)";
...
string global_audiofilename = "C:\\temp\\techno-minimal.wav";
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	myofstream << "spifractaltraceanimaudiobeat.exe" << endl << endl;
	...
	{    
		...
		{  
			...
			int maxnumberofframeforthisbeat = framenumber_next - framenumber_start;
			...
			for(int iframe=0; iframe<maxnumberofframeforthisbeat; iframe++)
			{
				...
				//double xstep = (global_fractaltrace_xmax-global_fractaltrace_xmin)*global_maxwindowwidthtranslationmultiple/(double) maxnumberofframeforthisbeat;
				//double ystep = (global_fractaltrace_ymax-global_fractaltrace_ymin)*global_maxwindowwidthtranslationmultiple/(double) maxnumberofframeforthisbeat;
				double xstep = (global_fractaltrace_xmax-global_fractaltrace_xmin)*global_maxwindowwidthtranslationmultiple/(double) 300;
				...
				FIBITMAP* pNew24bitDIB = FreeImage_Clone(p24bitDIB);
				if (pNew24bitDIB) 
				{
					// clone succeeded!
